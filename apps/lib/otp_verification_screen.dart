        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(
                widget.email ?? '${widget.countryCode}${widget.phoneNumber}',
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: _hasError
                              ...
                              : [
                                  const Color(0xFF701CF5), // Purple
                                  const Color(0xFF3E98E4), // Blue
                                ],
              ...
              GestureDetector(
                onTap: () {
                  Navigator.of(context).pop(); // Go back to phone/email input
                },
                child: Text(
                  widget.email != null
                      ? 'Use another email'
