...
class NotificationProvider
  ...
  _initializeNotificationService() async {
    try {
      ...
      NotificationService.instance.setOnUnreadCountChanged(
        (
          count,
        ) {
          _unreadCount = count;
      ...
      NotificationService.instance.setOnNewNotification(
        (
          notification,
        ) {
  ...
  updateUserStatus(
    ...
    NotificationService.instance.updateUserStatus(
      status,
    );
  }
  ...
  sendTypingIndicator(
    ...
    NotificationService.instance.sendTypingIndicator(
      recipientId,
      isTyping,
    );
  }
