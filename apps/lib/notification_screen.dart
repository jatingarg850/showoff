...
class _NotificationScreenState extends State<NotificationScreen> {
    ...
    switch (type) {
      ...
      case 'follow':
        ...
        if (sender?['_id'] != null) {
          ...
          print('Navigate to user profile: ${sender?['_id']}');
        }
        break;
      case 'vote':
        if (data['sytEntryId'] != null) {
          // Navigate to SYT entry
          // Navigator.push(context, MaterialPageRoute(builder: (context) => SYTScreen(entryId: data['sytEntryId'])));
          print('Navigate to SYT entry: ${data['sytEntryId']}');
        }
        break;
      case 'gift':
        // Show gift details or navigate to wallet
        print('Gift received: ${data['amount']} coins');
        break;
      case 'achievement':
        // Show achievement details
        print('Achievement unlocked: ${notification['title']}');
        break;
      default:
        break;
    }
  ...
  Widget _buildNotificationTile(Map<String, dynamic> notification) {
    ...
    final sender = notification['sender'] as Map<String, dynamic>?;
    final senderName =
        sender?['displayName'] ?? sender?['username'] ?? 'System';
    ...
    return Dismissible(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isRead
              ? Colors.white
              : const Color(0xFF701CF5).withOpacity(0.05),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(
            color: isRead
                ? Colors.grey[200]!
                : const Color(0xFF701CF5).withOpacity(0.2),
          ),
        ),
        child: ListTile(
            ...
            children: [
              Container(
                ...
                child: senderAvatar != null && senderAvatar.isNotEmpty
                    ? ClipOval(
                        child: Image.network(
                          ApiService.getImageUrl(senderAvatar),
                          fit: BoxFit.cover,
                          width: 50,
                          height: 50,
                    ...
                    : Icon(
                        type == 'achievement' || type == 'system'
                            ? Icons.emoji_events
                            : Icons.person,
                        color: type == 'achievement' || type == 'system'
                            ? Colors.amber
            ...
            TextSpan(
              children: type != 'system'
                  ...
                  : [
                      ...
                      if (notification['title'] != null && message.isNotEmpty)
                        TextSpan(
                          text: '\n$message',
                          style: const TextStyle(
                            color: Colors.black87,
