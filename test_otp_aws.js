/**
 * Test OTP with actual code in message - AWS SERVER
 * Tests that OTP is included in the SMS message
 */

const https = require('https');

const SERVER_URL = 'http://3.110.103.187';
...
async function testOTPWithCode() {
  console.log('\n╔════════════════════════════════════════════════════════╗');
  console.log('║  Test: OTP with Actual Code in Message (AWS)           ║');
  console.log('║  Server: http://3.110.103.187                          ║');
  console.log('╚════════════════════════════════════════════════════════╝\n');
