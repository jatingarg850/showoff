@echo off
REM ============================================================================
REM Build AAB (Android App Bundle) for Play Store
REM ============================================================================
REM This script builds a signed AAB for Play Store release using the keystore
...
echo.
echo ╔════════════════════════════════════════════════════════════════════════╗
echo ║                  ShowOff.life - AAB Build for Play Store               ║
echo ╚════════════════════════════════════════════════════════════════════════╝
echo.
...
if errorlevel 1 (
    ...
    echo - Check key.properties file: apps/key/key.properties
...
echo    - Config: apps/key/key.properties
echo.
echo 💡 Tips:
